...
public class EditableBufferedReader extends BufferedReader {
    ...
    public EditableBufferedReader(Line line, InputStreamReader reader) {
        super(reader);
        this.line = line;
    }
...
//javac -d build/classes/ -cp src src/mcv/TestReadLine.java
//java -cp build/classes/ mcv.TestReadLine